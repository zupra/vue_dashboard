...
.MainFullWidth
  ...
  fieldset
    ...
    .checked-group
      each item in ['Name','Age','Created On','Percent']
        label
          input(type='checkbox', name='checkbox', value='', checked )
          span.ripple  #{item}
      each _,i in Array(22)
        label
  ...
  VueGoodTable(
    ...
    :lineNumbers="true",
    :search-options="{enabled: true}",
    :pagination-options="{enabled: true, mode: 'records', nextLabel: 'туда', prevLabel: 'Сюда', rowsPerPageLabel: 'Выводить на страницу по:', ofLabel: 'из', allLabel: 'Все'}"
  )
...
const rows = [
  { id: 0, name: 'John', age: 20, createdAt: '201-10-31', score: 0.1 },
  { id: 1, name: 'Жу', age: 24, createdAt: '2011-10-31', score: 0.05 },
  { id: 2, name: 'Jane', age: 24, createdAt: '2011-10-31', score: 0.05 },
  { id: 3, name: 'Susan', age: 16, createdAt: '2011-10-30', score: 0.06 },
  { id: 4, name: 'Chris', age: 55, createdAt: '2011-10-11', score: 0.07 },
  { id: 5, name: 'Dan', age: 40, createdAt: '2011-10-21', score: 0.08 },
  { id: 6, name: 'John', age: 20, createdAt: '2011-10-31', score: 0.09 },
  { id: 7, name: 'Малой', age: 16, createdAt: '2011-10-30', score: 0.06 },
  { id: 8, name: 'Старый', age: 55, createdAt: '2011-10-11', score: 0.07 },
  { id: 9, name: 'Средний', age: 40, createdAt: '2011-10-21', score: 0.08 },
  { id: 10, name: 'Пацан', age: 20, createdAt: '2011-10-31', score: 0.09 }
]
...
export default {
  ...
  //     return error({ message: 'report/name not found', statusCode: 404 })
  //   }
  //   return params
  // }
  asyncData({ params }) {
...
.sorting
  ...
  &-desc
    background #fff5ee url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='22' height='12'><polygon points='0,0 16,0 8,12' fill='#ed5565'/></svg>") 100% no-repeat;
  &-asc
    background #fff5ee url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='22' height='12'><polygon points='0,12 16,12 8,0' fill='#ed5565'/></svg>") 100% no-repeat;
.vgt-table
  background #FFF
